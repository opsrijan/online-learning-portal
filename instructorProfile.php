<?php
    ...
    if (isset($_POST['update'])){
        ...
        $email = $_POST['email'];
        $passwd = $_POST['passwd'];
        $sql = "UPDATE `instructor` SET `Name`='".$name."', `Email`='".$email."', `Password`='".$passwd."' WHERE InstructorID = ".$_SESSION['logger'];
...
<body>
    ...
    ?>
    <?php
        echo "InstructorID: " .$_SESSION['logger'];
    ?>
    <br>
    <?php
    if (isset($_POST['edit'])){
        echo "<form action='instructorProfile.php' method='POST'>
    ...
    echo "<a href='instructorDashboard.php'>Dashboard</a>"
    ?>
</body>
</html>
